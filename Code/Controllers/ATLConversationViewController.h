...
/**
 @abstract A Boolean value that determines whether or not an avatar is shown for other participants in the conversation.
 @default `NO`.
 Should be set before `[super viewDidLoad]` is called.
 */
@property (nonatomic) BOOL shouldDisplayAvatarItemForOtherParticipants;
