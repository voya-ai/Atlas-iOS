...
- (LYRMessageMock *)newMessageWithParts:(NSSet *)messageParts options:(NSDictionary *)options error:(NSError **)error;
- (LYRMessageMock *)newPlatformMessageWithParts:(NSSet *)messageParts senderName:(NSString *)senderName options:(NSDictionary *)options error:(NSError **)error;
